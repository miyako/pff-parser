#ifndef __PFF_PARSER_H__
#define __PFF_PARSER_H__
...
#define _libpff_file_open libpff_file_open_wide
#else
#define _unlink unlink
#define _libpff_file_open libpff_file_open
#endif
